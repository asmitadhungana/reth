...
Pruning:
      ...
      --minimal
          ...
          This mode configures the node to use minimal disk space by: - Fully pruning sender recovery, transaction lookup, receipts, account/storage history, and block bodies - Using 10,000 blocks per static file segment
